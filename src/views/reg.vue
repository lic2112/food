            ...
            <div class="am-u-sm-10 myapp-login-form">
                <form class="am-form">
                    <fieldset>
                        ...
                        <p>
                            <button type="button" class="am-btn am-btn-default" @click="reg">Register</button>
                        </p>
...
export default {
    ...
    methods: {
        reg() {
            this.$http.post('http://localhost:3000/register', { username: this.luser, password: this.lpass }).then(res => {
